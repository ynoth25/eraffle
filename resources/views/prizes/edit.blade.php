...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('prizes.update', compact('prize')) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', $prize->code ?? '') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="status" type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status', $prize->status ?? '') }}">
                    ...
                    <div class="col-md-6">
                        <select id="promo" name="promo_id" class="form-select @error('promo_id') is-invalid @enderror">
                            ...
                            @foreach ($promos as $promo)
                                ...
                                <!-- Adjust to your promo's name attribute -->
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror"
                            name="quantity" value="{{ old('quantity', $prize->quantity ?? '') }}">
                    ...
                    <div class="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h2 class="card-title">Edit Prize</h2>
                                <form method="POST" action="{{ route('prizes.update', compact('prize')) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="code" type="text"
                                                ...
                                                name="code" value="{{ old('code', $prize->code ?? '') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="status" type="text"
                                                ...
                                                name="status" value="{{ old('status', $prize->status ?? '') }}">
