                        ...
                        <select id="promoSelect" name="promo_id" class="form-select">
                            ...
                            @foreach ($promos as $promo)
                                <option value="{{ $promo->id }}"
                                    {{ request('promo_id') == $promo->id ? 'selected' : '' }}>{{ $promo->name }}</option>
                            @endforeach
                        </select>
                    </div>
                                ...
                                <div class="row mb-3 align-items-center">
                                    <div class="col-md-4">
                                        <select id="promoSelect" name="promo_id" class="form-select">
                                            ...
                                            @foreach ($promos as $promo)
                                                <option value="{{ $promo->id }}"
                                                    {{ request('promo_id') == $promo->id ? 'selected' : '' }}>
                                                    {{ $promo->name }}</option>
                                            @endforeach
                                        </select>
                                        <button type="submit" class="btn btn-primary"
                                            style="padding:13px;">{{ __('Search') }}</button>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="col-md-4 text-end">
                                                ...
                                                <a href="{{ route('prizes.create') }}"
                                                    style="border: 1px solid #98ddaa; border-radius: 5px; padding: 5px;">
                                                    {{ __('Create Prize') }}
                                                </a>
                                            </div>
                                        </th>
                                ...
                                <tbody>
                                    @forelse($prizes as $prize)
                                        <tr>
                                            ...
                                            <td>{{ $prize->status }}</td>
                                            <td>
                                                <a href="{{ route('prizes.edit', compact('prize')) }}"
                                                    style="border: 1px solid #008CBA; border-radius: 5px; padding: 13px; margin-right: 5px;">
                                                    Edit
                                                </a>
                                                <form action="{{ route('prizes.destroy', $prize->id) }}"
                                                    method="POST"
                                                    onsubmit="return confirm('Are you sure you want to delete this prize?');"
                                                    style="display: inline;">
                                                    @csrf
