                    ...
                    <div class="main-content">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h2 class="card-title">Prize Details</h2>
                                <div class="row mb-3">
                                    <label for="code"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <p id="description" class="form-control-plaintext">{{ $prize->description }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                @if ($prize->file)
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ Storage::url($prize->file) }}" class="btn btn-primary"
                                                target="_blank">
                                                {{ __('View File') }}
                                            </a>
                                        </div>
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <a href="{{ route('prizes.edit', $prize->id) }}"
                                            class="btn btn-primary"style="border: 1px solid black; border-radius: 5px; padding: 5px; margin-right: 2px;">
                                            {{ __('Edit') }}
                                        </a>
                                        <a href="{{ url()->previous() }}" class="btn btn-secondary"
