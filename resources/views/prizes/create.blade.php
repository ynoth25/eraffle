                    ...
                    <div class="main-content">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h2 class="card-title">Create Prize</h2>
                                <form method="POST" action="{{ route('prizes.store') }}"
                                    ...
                                    <div class="row mb-3">
                                        <label for="promo"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Select Promo') }}</label>

                                        <div class="col-md-12">
                                            <select id="promo" name="promo_id"
                                                class="form-select @error('promo_id') is-invalid @enderror">
                                                <option value="" disabled selected>{{ __('Choose a promo') }}
                                                </option>
                                                @foreach ($promos as $promo)
                                                    <option value="{{ $promo->id }}">{{ $promo->name }}</option>
                                                    <!-- Adjust to your promo's name attribute -->
                                    ...
                                    <div class="row mb-3">
                                        <label for="file"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Upload (Optional)') }}</label>
