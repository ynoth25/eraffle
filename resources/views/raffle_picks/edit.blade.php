        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ route('raffle_picks.update', ['raffle_pick' => $rafflePick->id, 'promo' => $promo->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="entry" type="text"
                                        class="form-control @error('entry') is-invalid @enderror" name="entry"
                                        value="{{ $rafflePick->entry->name ?? '' }}" readonly>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="prize" type="text"
                                        ...
                                        value="{{ $rafflePick->prize->description ?? '' }}" readonly>
                            ...
                            <div class="row mb-3">
                                <label for="email"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Picked Date') }}</label>

                                <div class="col-md-6">
                                    <input id="pick_date" type="text"
                                        class="form-control @error('pick_date') is-invalid @enderror" name="pick_date"
                                        value="{{ $rafflePick->pick_date ?? '' }}" readonly>
                            ...
                            <div class="row mb-3">
                                <label for="email"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Has User Won?') }}</label>

                                <div class="col-md-6">
                                    <input type="checkbox" id="is_winner" name="is_winner" value="1"
                                        {{ $rafflePick->is_winner ? 'checked' : '' }}>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <form
                                    ...
                                    <div class="row mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Entry') }}</label>

                                        <div class="col-md-6">
                                            <input id="entry" type="text"
                                                class="form-control @error('entry') is-invalid @enderror"
                                                name="entry" value="{{ $rafflePick->entry->name ?? '' }}" readonly>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="prize" type="text"
                                                ...
                                                name="prize" value="{{ $rafflePick->prize->description ?? '' }}"
                                                readonly>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="pick_date" type="text"
                                                ...
                                                name="pick_date" value="{{ $rafflePick->pick_date ?? '' }}" readonly>
                                    ...
                                    <div class="row mb-0">
                                        ...
                                        <div class="col-md-6 offset-md-4">
                                            <a href="{{ route('raffle_picks.index', compact('promo')) }}"
                                                style="border: 1px solid hsl(136, 50%, 73%); border-radius: 5px; padding: 5px;">
                                                Back to list
                                            </a>
                                        </div>
                                    </div>
