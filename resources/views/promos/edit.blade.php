            ...
            <form method="POST" action="{{ route('promos.update', $promo->id) }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" value="{{ old('name', $promo->name ?? '') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="end_date" type="text" class="form-control @error('end_date') is-invalid @enderror"
                            name="end_date" value="{{ old('end_date', $promo->end_date ?? '') }}">
                ...
                <div class="row mb-3">
                    <label for="terms_and_conditions"
                        class="col-md-4 col-form-label text-md-end">{{ __('Terms & Conditions') }}</label>

                    <div class="col-md-6">
                        <input id="terms_and_conditions" type="text"
                            class="form-control @error('terms_and_conditions') is-invalid @enderror"
                            name="terms_and_conditions"
                            value="{{ old('terms_and_conditions', $promo->terms_and_conditions ?? '') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        @if ($promo->poster)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $promo->poster) }}" alt="Promo Poster"
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <form class="horizontal-form" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label for="terms_and_conditions">Terms and Condition:</label>
                                        <input id="terms_and_conditions" type="text"
                                            class="form-control @error('terms_and_conditions') is-invalid @enderror"
                                            name="terms_and_conditions"
                                            value="{{ old('terms_and_conditions', $promo->terms_and_conditions ?? '') }}">
                                    ...
                                    <div class="form-group submit">
                                        <a href="{{ route('promos.index') }}"
                                            style="padding: 15px; background-color: #29d49f; text-align:center;">
                                            {{ __('Back to Promo List') }}
                                        </a>
                                    </div>
                                </form>
