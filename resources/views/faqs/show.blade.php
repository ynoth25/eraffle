                    ...
                    <div class="main-content">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h2 class="card-title">FAQ Details</h2>
                                <p><strong>Question: </strong>&nbsp; &nbsp; {{ $faq->question }}</p>
                                <p><strong>Answer:</strong>&nbsp; &nbsp; {{ $faq->answer }}</p>

                                <a href="{{ route('faqs.edit', $faq->id) }}" class="btn btn-warning"
                                    style="border: 1px solid black; border-radius: 5px; padding: 13px; margin: 2px;">Edit</a>
                                ...
                                <a href="{{ route('faqs.index') }}" class="btn btn-danger"
                                    style="border: 1px solid black; border-radius: 5px; padding: 13px; margin: 2px;">Back
                                    to FAQ List</a>
                            </div>
                        </div>
                    </div>
