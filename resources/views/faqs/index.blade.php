 ...
 */
    ...
    <style>
        ...
        /* Search container inside the card */
        .search-container {
            display: flex;
            margin-bottom: 20px;
        }
                    ...
                    <div class="main-content">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <!-- Search form on top of the card -->
                                <!-- Search form on top of the card -->
                                <form method="GET" action="{{ route('faqs.index') }}">
                                    ...
                                    <div class="form-group" style="width: 200px;">
                                        <select name="per_page" class="form-control">
                                            <option value="10" {{ $perPage == 10 ? 'selected' : '' }}>10 per page
                                            </option>
                                            <option value="25" {{ $perPage == 25 ? 'selected' : '' }}>25 per page
                                            </option>
                                            <option value="50" {{ $perPage == 50 ? 'selected' : '' }}>50 per page
                                            </option>
                                        </select>
                                    </div>
                                </form>
                                ...
                                <a href="{{ route('faqs.create') }}"
                                    style="border: 1px solid #f44336; border-radius: 5px; padding: 14px; margin: 2px;">Create
                                    New FAQ</a>
                                <br>
                                    ...
                                    <tbody>
                                        @forelse($faqs as $faq)
                                            <tr>
                                                <td>{{ $faq->question }}</td>
                                                <td>{{ $faq->answer }}</td>
                                                <td>{{ $faq->promo->name ?? 'No Promo' }}</td>
                                                <!-- Display the promo name -->
                                                <td>
                                                    <a href="{{ route('faqs.show', $faq->id) }}"
                                                        class="btn btn-info btn-sm"
                                                        style="border: 1px solid black; border-radius: 5px; padding: 14px; margin: 2px;">View</a>
                                                    <a href="{{ route('faqs.edit', $faq->id) }}"
                                                        class="btn btn-warning btn-sm"
                                                        style="border: 1px solid black; border-radius: 5px; padding: 14px; margin: 2px;">Edit</a>
                                                    <form action="{{ route('faqs.destroy', $faq->id) }}"
                                                        method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            style="border: 1px solid black; border-radius: 5px; padding 5px; margin: 2px;"
                                                            onclick="return confirm('Are you sure?')">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                    ...
                                    <ul class="alignleft">
                                        <li class="ssi-email"><a
                                                href="mailto:&#112;&#117;r&#101;&#098;&#108;&#111;&#111;m&#050;4&#064;gmai&#108;.c&#111;&#109;"><svg
                                                    role="img" class="social-email"
                                                    aria-labelledby="social-email-3">
