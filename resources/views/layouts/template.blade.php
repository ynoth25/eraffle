...
<body
    ...
    <div id="page" class="site">
                    ...
                    <nav id="site-navigation" class="main-navigation" aria-label="Top Menu">
                        ...
                        <div class="menu-top-menu-container">
                            <ul id="top-menu" class="menu">
                                ...
                                <li id="menu-item-124"
                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-118 current_page_item menu-item-124">
        ...
        <div class="single-featured-image-header"><img width="2000" height="1200"
                ...
                alt="" decoding="async" sizes="100vw" /></div><!-- .single-featured-image-header -->
                ...
                <div class="wrap">
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main">
                            ...
                            <article id="post-118"
                                class="post-118 page type-page status-publish has-post-thumbnail hentry">
                                <header class="entry-header">
                                    <h1 class="entry-title">About Us</h1>
                                </header><!-- .entry-header -->
                                <div class="entry-content">
                                    <div data-elementor-type="wp-post" data-elementor-id="118"
                                        class="elementor elementor-118">
                                        <div class="elementor-element elementor-element-09291e6 e-flex e-con-boxed e-con e-parent"
                                            data-id="09291e6" data-element_type="container">
                                            <div class="e-con-inner">
                                                <div class="elementor-element elementor-element-18270ea elementor-widget elementor-widget-heading"
                                                    data-id="18270ea" data-element_type="widget"
                                                    data-widget_type="heading.default">
                                                    <div class="elementor-widget-container">
                                                        <h2 class="elementor-heading-title elementor-size-default">Pure
                                                            Intentions, Blooming Possibilites.</h2>
                                                    </div>
                                                </div>
                                                <div class="elementor-element elementor-element-302bd1c elementor-widget elementor-widget-text-editor"
                                                    data-id="302bd1c" data-element_type="widget"
                                                    data-widget_type="text-editor.default">
                                                    <div class="elementor-widget-container">
                                                        <p>PureBloom, established in April 2024, is dedicated to
                                                            advancing the health and wellness movement. Committed to
                                                            excellence, we provide high-quality products designed to
                                                            meet evolving client needs. Our passion for health and focus
                                                            on quality ensure that every product we offer enhances the
                                                            lives of those who rely on us.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="elementor-element elementor-element-73fd489 e-grid e-con-boxed e-con e-parent"
                                            data-id="73fd489" data-element_type="container">
                                            <div class="e-con-inner">
                                                <div class="elementor-element elementor-element-2f09a37 elementor-widget elementor-widget-image"
                                                    data-id="2f09a37" data-element_type="widget"
                                                    data-widget_type="image.default">
                                                    <div class="elementor-widget-container">
                                                        <img loading="lazy" decoding="async" width="245"
                                                            height="300"
                                                            src="https://purebloom.ph/wp-content/uploads/2024/09/mission-245x300.png"
                                                            class="attachment-medium size-medium wp-image-103"
                                                            alt=""
                                                            srcset="https://purebloom.ph/wp-content/uploads/2024/09/mission-245x300.png 245w, https://purebloom.ph/wp-content/uploads/2024/09/mission.png 409w"
                                                            sizes="100vw" />
                                                    </div>
                                                </div>
                                                <div class="elementor-element elementor-element-486c8b8 elementor-widget elementor-widget-image"
                                                    data-id="486c8b8" data-element_type="widget"
                                                    data-widget_type="image.default">
                                                    <div class="elementor-widget-container">
                                                        <img loading="lazy" decoding="async" width="224"
                                                            height="300"
                                                            src="https://purebloom.ph/wp-content/uploads/2024/09/Vision-224x300.png"
                                                            class="attachment-medium size-medium wp-image-104"
                                                            alt=""
                                                            srcset="https://purebloom.ph/wp-content/uploads/2024/09/Vision-224x300.png 224w, https://purebloom.ph/wp-content/uploads/2024/09/Vision.png 374w"
                                                            sizes="100vw" />
                                                    </div>
                                                </div>
                                                <div class="elementor-element elementor-element-01d65f7 elementor-widget elementor-widget-text-editor"
                                                    data-id="01d65f7" data-element_type="widget"
                                                    data-widget_type="text-editor.default">
                                                    <div class="elementor-widget-container">
                                                        <p>PureBloom was founded with PURE intentions of providing
                                                            quality products and excellent customer service in this
                                                            BLOOMing health and wellness era.</p>
                                                    </div>
                                                </div>
                                                <div class="elementor-element elementor-element-e3eec8d elementor-widget elementor-widget-text-editor"
                                                    data-id="e3eec8d" data-element_type="widget"
                                                    data-widget_type="text-editor.default">
                                                    <div class="elementor-widget-container">
                                                        <p>We envision a world where wellness and entrepreneurship go
                                                            hand in hand, where individuals can thrive in both health
                                                            and wealth. Through our innovative products and direct
                                                            selling platform, we aim to be a global leader in the health
                                                            and wellness industry, inspiring people to blossom into
                                                            their best selves.</p>
                                                    </div>
                                                </div>
                                            </div>
